        ...
        <div className="flex-1 flex flex-col min-w-0">
          {selectedPhone ? (
            <>
              ...
              <div
                className={`px-5 py-1.5 flex items-center gap-2 text-xs border-b flex-shrink-0 ${
                      ...
                      .map(([chatId, chat]) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <div
                              className={`text-sm font-medium truncate ${selectedChatId === chatId ? 'text-indigo-700' : 'text-gray-900'}`}
                            >
                              {chat.displayName}
                            </div>
                            {chat.lastMessage && (
