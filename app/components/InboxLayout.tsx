          ...
          {selectedPhone ? (
            <>
                ...
                {selectedPhone && Object.keys(allChats[selectedPhone.id] ?? {}).length > 0 && (
                  <div className="w-64 border-r border-gray-200 bg-white overflow-y-auto flex-shrink-0">
                    <div className="px-4 py-3 border-b border-gray-100">
                      <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Conversations</h3>
                    </div>
              ...
              {selectedChatId ? (
                <ConversationView
                  ...
                  displayName={
                    allChats[selectedPhone.id]?.[selectedChatId]?.displayName ??
                    selectedChatId
                  }
                  messages={
                    allMessages[selectedPhone.id]?.[selectedChatId] ?? []
                  }
                  onSendMessage={text =>
                    handleSendMessage(selectedPhone, selectedChatId, text)
                  }
                ...
                <div className="flex-1 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-500 text-sm">
                      Messages appear here in real-time via webhooks.
                    </p>
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-500 text-sm">
                  Choose a phone number from the sidebar
                </p>
              </div>
            </div>
          )}
